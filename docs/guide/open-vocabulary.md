...
| A protocol document's `evidence_kinds:` block | `website/docs/reference/vocabulary.md:50` — "adds two more, each minted by the verb that ran the check" | open | `protocols/aep/1.yaml:evidence_kinds` | — | — | — |
| A protocol document's `verifiers:` block | `website/docs/reference/vocabulary.md:68` — "the producers of the two evidence kinds it" | open | `protocols/aep/1.yaml:verifiers` | — | — | — |
| A protocol document's `artifact_kinds:` block | `docs/plan/document-authoring-brief.md:56` — "is satisfied by any design subkind" | open | `protocols/aep/1.yaml:artifact_kinds` | — | — | — |
| A protocol document's `phases:` block | `website/docs/reference/vocabulary.md:132` — "decomposition verification-setup adversarial-verification" | open | `protocols/aep/1.yaml:phases` | — | — | — |
| A protocol document's `observables:` block | `website/docs/reference/vocabulary.md:138` — "A predicate may only read these" | open | `protocols/aep/1.yaml:observables` | — | — | — |
| A protocol document's `scales:` block | `website/docs/reference/vocabulary.md:154` — "on non-numeric values" | open | `protocols/aep/1.yaml:scales` | — | — | — |

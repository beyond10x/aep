<!-- Rendered from `migration/forward-only/1` by `protocol govern workflow instruct`. Do not edit: change the workflow document or the principles timed against its phases, and render again. -->

# Forward-only migration

`migration/forward-only/1` · 5 states · 4 transitions · 21 principles bind it.

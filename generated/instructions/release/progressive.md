<!-- Rendered from `release/progressive/1` by `protocol govern workflow instruct`. Do not edit: change the workflow document or the principles timed against its phases, and render again. -->

# Progressive release

`release/progressive/1` · 7 states · 6 transitions · 20 principles bind it.

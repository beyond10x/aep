...
const DOCUMENT: &str = "crates/protocol-cli/tests/fixtures/reverse-openapi/order-service.yaml";

/// The recorded draft.
const RECORDED: &str = "crates/protocol-cli/tests/fixtures/reverse-openapi/expected/draft.yaml";

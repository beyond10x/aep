...
///
/// `crates/drive/aep-driver-spec/tests/published_pattern_evaluated.rs` evaluates every published pattern
...
impl schemars::JsonSchema for SubjectRef {
    ...
    fn json_schema(_: &mut schemars::gen::SchemaGenerator) -> schemars::schema::Schema {
        ...
        // `crates/drive/aep-driver-spec/tests/published_pattern_evaluated.rs`, which names it rather than

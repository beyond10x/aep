...
fn a_conformance_report_is_read_into_the_record_rather_than_typed_at_it() {
    ...
    let report =
        repository.join("crates/edge/protocol-cli/tests/fixtures/conformance-reports/passed.json");
...
fn a_report_of_no_scenarios_is_refused_because_it_asserts_nothing() {
    ...
    copy_tree(&repository.join(FIXTURE), &store);
    let report =
        repository.join("crates/edge/protocol-cli/tests/fixtures/conformance-reports/empty.json");
...
fn a_review_results_findings_block_is_parsed_at_new_and_returned_by_show_as_an_array() {
    ...
    review_of(
        ...
        &findings_body(&format!(
            ...
            "- file: crates/edge/protocol-cli/src/planning.rs\n  category: docs\n  severity: note\n  \

...
//! `crates/edge/protocol-cli/fixtures/metaharness-contract-result-{claude,codex,b10x}.json` and hold
...
//!
//! `crates/edge/protocol-cli/src/contract.rs` tests the reading rules directly. What only a test through
...
const CLAUDE_RECORD: &str =
    "crates/edge/protocol-cli/fixtures/metaharness-contract-result-claude.json";

/// `metaharness conformance codex --contract`, captured: 10 vectors, all green.
const CODEX_RECORD: &str =
    "crates/edge/protocol-cli/fixtures/metaharness-contract-result-codex.json";

/// `metaharness conformance b10x --contract`, captured: 5 vectors, all green.
const B10X_RECORD: &str = "crates/edge/protocol-cli/fixtures/metaharness-contract-result-b10x.json";

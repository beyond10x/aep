...
//! `crates/edge/protocol-cli/fixtures/eval-matrix/runs/` is the output of this repository's own checker
//! over a committed transcript, minted with
//!
//! ```console
//! protocol trace check --spec crates/edge/protocol-cli/fixtures/eval-matrix/expectations.development-story.trace.yaml \
...
//! (`crates/observe/trace-spec/tests/fixtures/`: the plugin eval's session, the driven honest step and the
...
/// The committed runs.
const RUNS: &str = "crates/edge/protocol-cli/fixtures/eval-matrix/runs";
